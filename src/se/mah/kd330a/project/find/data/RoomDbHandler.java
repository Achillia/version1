...
public class RoomDbHandler extends SQLiteOpenHelper {
	...
	private void dbCreate(SQLiteDatabase db) {
		...
		addRow(db, "ORD131", 422, 687, "or", "1");
		addRow(db, "ORD138", 590, 690, "or", "1");
		addRow(db, "ORC236", 486, 519, "or", "2");
		addRow(db, "ORD222", 292, 686, "or", "2");
		addRow(db, "ORE222", 295, 894, "or", "2");
		addRow(db, "ORE223", 295, 846, "or", "2");
		addRow(db, "ORE235", 498, 901, "or", "2");
		addRow(db, "ORE239", 618, 847, "or", "2");
		addRow(db, "ORE240", 618, 896, "or", "2");
		addRow(db, "ORF206", 1085, 1087, "or", "2");
		addRow(db, "ORF208", 0, 0, "or", "2");
		addRow(db, "ORF209", 280, 1017, "or", "2");
		addRow(db, "ORF211", 384, 1035, "or", "2");
		addRow(db, "ORF215", 582, 1035, "or", "2");
		addRow(db, "ORF219", 622, 1082, "or", "2");
		addRow(db, "ORF220", 622, 1028, "or", "2");
		addRow(db, "ORC323", 318, 490, "or", "3");
		addRow(db, "ORC333", 509, 486, "or", "3");
		addRow(db, "ORC334", 530, 486, "or", "3");
		addRow(db, "ORC335", 550, 486, "or", "3");
		addRow(db, "ORC336", 571, 486, "or", "3");
		addRow(db, "ORC339", 460, 516, "or", "3");
		addRow(db, "ORC340", 498, 516, "or", "3");
		addRow(db, "ORC341", 542, 516, "or", "3");
		addRow(db, "ORC344", 646, 483, "or", "3");
		addRow(db, "ORC345", 646, 534, "or", "3");
		addRow(db, "ORC377", 655, 592, "or", "3");
		addRow(db, "ORD326", 428, 696, "or", "3");
		addRow(db, "ORD328", 316, 672, "or", "3");
		addRow(db, "ORD331", 529, 696, "or", "3");
		addRow(db, "ORD337", 645, 672, "or", "3");
		addRow(db, "ORD377", 657, 781, "or", "3");
		addRow(db, "ORE323", 314, 851, "or", "3");
		addRow(db, "ORE336", 489, 903, "or", "3");
		addRow(db, "ORE337", 533, 903, "or", "3");
		addRow(db, "ORE340", 641, 850, "or", "3");
		addRow(db, "ORE341", 641, 901, "or", "3");
		addRow(db, "ORF306", 351, 1089, "or", "3");
		addRow(db, "ORF307", 315, 1039, "or", "3");
		addRow(db, "ORF309", 410, 1039, "or", "3");
		addRow(db, "ORF312", 546, 1039, "or", "3");
		addRow(db, "ORF314", 641, 1039, "or", "3");
		addRow(db, "ORF315", 641, 1087, "or", "3");
		addRow(db, "ORC435", 496, 545, "or", "4");
		addRow(db, "ORC436", 538, 545, "or", "4");
		addRow(db, "ORC440", 646, 517, "or", "4");
		addRow(db, "ORD436", 531, 678, "or", "4");
		addRow(db, "ORE436", 537, 909, "or", "4");
		addRow(db, "ORE439", 647, 861, "or", "4");
		addRow(db, "ORE477", 663, 967, "or", "4");
		addRow(db, "ORC525", 463, 534, "or", "5");
		addRow(db, "ORC526", 388, 478, "or", "5");
		addRow(db, "ORC527", 450, 478, "or", "5");
		addRow(db, "ORC528", 521, 478, "or", "5");
